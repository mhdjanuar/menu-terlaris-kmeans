...
//        restrictAccess();
    ...
    public void start(UserModel user){
       ...
       Home.setLayout(new GridBagLayout()); // agar isi panel di tengah otomatis
        ...
        JLabel homeLabel2 = new JLabel("Sistem Keputusan Pemilihan Makanan dan Minuman Terlaris");
        JLabel homeLabel3 = new JLabel("Pada Restoran Salt Menggunakan Algoritma K means");
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/logo-makan(1).png"))); // NOI18N
        ...
        perhitunganSPK.setText("      DATA PENJUALAN");
        ...
        profil1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        profil1.setForeground(new java.awt.Color(255, 255, 255));
        profil1.setText("      PERHITUNGAN KMEANS");
        profil1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                profil1MouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                profil1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                profil1MouseExited(evt);
            }
        });
        ...
        SidebarLayout.setHorizontalGroup(
            ...
            .addComponent(profil1, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
        );
    ...
    private void profilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profilMouseClicked
        ...
        // add Panel, add panel
        MainContent.add(new DataAnalisaView());
        MainContent.repaint();
        MainContent.revalidate();
    ...
    private void listDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listDataMouseClicked
        ...
        // add Panel, add panel
        MainContent.add(new DataMenuView());
        MainContent.repaint();
        MainContent.revalidate();
    ...
    private void profil1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profil1MouseClicked
        MainContent.removeAll();
        MainContent.repaint();
        MainContent.revalidate();

        // add Panel, add panel
        MainContent.add(new SalesKmeansView());
        MainContent.repaint();
        MainContent.revalidate();
    }//GEN-LAST:event_profil1MouseClicked

    private void profil1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profil1MouseEntered
        // TODO add your handling code here:
        profil1.setBackground(new Color(41,44,69));
        profil1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        profil1.setForeground(new Color(255, 187, 0));
    }//GEN-LAST:event_profil1MouseEntered

    private void profil1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profil1MouseExited
        // TODO add your handling code here:
        profil1.setBackground(new Color(45,49,74));
        profil1.setForeground(Color.white);
    }//GEN-LAST:event_profil1MouseExited
